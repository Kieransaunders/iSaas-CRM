...
description: Convex documentation optimized for LLMs - complete reference for queries, mutations, actions, auth, scheduling, file storage, and more.
last_fetched: 2026-02-05
---
...
> 
> This is a local copy of the Convex LLM documentation for offline reference. Visit the official docs for the most up-to-date information.
