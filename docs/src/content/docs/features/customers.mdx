...
description: Managing your client companies in your CRM
---

Customers represent the **client companies** that access your **CRM**. Each customer gets their own secure, isolated space within your platform.

## What is a Customer?

A Customer is a client company that uses your CRM. Each Customer:

- Gets their own isolated data space (other clients can't see their data)
- Can have multiple users (employees) who log into your CRM
...
Customers have a self-service area where they can:
