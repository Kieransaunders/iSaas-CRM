---
title: Organizations
description: Your agency and the foundation of your CRM
---

Your Organization represents **your agency**—the foundation of your CRM SaaS platform.
...
- Is the owner of your CRM platform
- Manages your team (Admin and Staff roles)
- Contains your Customers (the clients who use your CRM)
- Handles billing and subscriptions for your CRM service
...
export const getCurrent = query({
  handler: async (ctx) => {
    ...
    return await ctx.db
      .query('organizations')
      .withIndex('by_workos_org_id', (q) => q.eq('workosOrgId', user.orgId))
      .unique();
  },
});
```
